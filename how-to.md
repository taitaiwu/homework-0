...
1. 前往課程的 GitHub 專案頁面：https://github.com/NCUE-CS-UNIX-2026-Spring/homework-0
2. 點擊頁面右上角的 **Fork** 按鈕
...
在 fork 的專案中添加上游遠端：
```bash
git remote add upstream https://github.com/NCUE-CS-UNIX-2026-Spring/homework-0.git
git fetch upstream
